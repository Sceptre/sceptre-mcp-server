...
def create_context(command_path: str, project_path: str = ".", **kwargs) -> SceptreContext:
...
def sceptre_launch(
    ...
    try:
        ...
        result = {
            "status": "success",
            "stacks": {str(stack): str(response) for stack, response in responses.items()},
...
def sceptre_generate(
    ...
    try:
        ...
        result = {
            "templates": {str(stack): template for stack, template in responses.items()},
...
def sceptre_drift_detect(
    ...
    try:
        ...
        result = {
            "drift_results": {str(stack): response for stack, response in responses.items()}
        }
...
def sceptre_drift_show(
    ...
    try:
        ...
        result = {
            "drift_details": {str(stack): response for stack, response in responses.items()}
        }
